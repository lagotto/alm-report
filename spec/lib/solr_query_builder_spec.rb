...
describe SolrQueryBuilder do
  it "can build simple queries" do
    ...
    build_query_test_once({everything: "foo bar blaz"},
  ...
  it "can handle institution and author_country both mapping to affiliate" do
    ...
    build_query_test_once({author_country: "authorCountry"},
      "affiliate:authorCountry")

    build_query_test_once({everything: "everythingInst",
      institution: "foo institution"},
      'affiliate:"foo institution" AND everything:everythingInst')

    build_query_test_once({author_country: "france",
