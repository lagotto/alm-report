...
env_vars = %w{ DB_USERNAME DB_HOST HOSTNAME MEMCACHE_SERVERS SITENAME SECRET_KEY_BASE MODE SEARCH SOLR_URL SOLR_MAX_DOIS ALM_URL ALM_API_KEY PER_PAGE METRICS_PER_PAGE ARTICLE_LIMIT VIZ_LIMIT OMNIAUTH }
